...
/**
    * 订单表
    */
@ApiModel(value="com-cskt-entity-HotelOrder")
@Data
@Builder
@AllArgsConstructor
@NoArgsConstructor
...
public class HotelOrder implements Serializable {
    ...
    public static final String COL_BOOKING_DAYS = "booking_days";

    public static final String COL_CHECK_IN_DATE = "check_in_date";

    public static final String COL_CHECK_OUT_DATE = "check_out_date";
    ...
    public static final String COL_NOTICE_PHONE = "notice_phone";

    public static final String COL_NOTICE_EMAIL = "notice_email";

    public static final String COL_SPECIAL_REQUIREMENT = "special_requirement";

    public static final String COL_IS_NEED_INVOICE = "is_need_invoice";

    public static final String COL_INVOICE_TYPE = "invoice_type";

    public static final String COL_INVOICE_HEAD = "invoice_head";
