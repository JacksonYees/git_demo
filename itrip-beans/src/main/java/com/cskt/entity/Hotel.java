...
/**
    * 酒店表
    */
@ApiModel(value="com-cskt-entity-Hotel")
@Data
@Builder
@AllArgsConstructor
@NoArgsConstructor
...
public class Hotel implements Serializable {
    ...
    public static final String COL_HOTEL_POLICY = "hotel_policy";

    public static final String COL_HOTEL_TYPE = "hotel_type";

    public static final String COL_HOTEL_LEVEL = "hotel_level";

    public static final String COL_IS_GROUP_PURCHASE = "is_group_purchase";

    public static final String COL_REDUNDANT_CITY_NAME = "redundant_city_name";

    public static final String COL_REDUNDANT_PROVINCE_NAME = "redundant_province_name";

    public static final String COL_REDUNDANT_COUNTRY_NAME = "redundant_country_name";

    public static final String COL_REDUNDANT_HOTEL_STORE = "redundant_hotel_store";
