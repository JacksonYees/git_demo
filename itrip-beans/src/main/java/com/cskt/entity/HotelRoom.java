...
/**
    * 酒店房间表
    */
@ApiModel(value="com-cskt-entity-HotelRoom")
@Data
@Builder
@AllArgsConstructor
@NoArgsConstructor
...
public class HotelRoom implements Serializable {
    ...
    public static final String COL_ROOM_TITLE = "room_title";

    public static final String COL_ROOM_PRICE = "room_price";

    public static final String COL_ROOM_BED_TYPE_ID = "room_bed_type_id";

    public static final String COL_IS_HAVING_BREAKFAST = "is_having_breakfast";

    public static final String COL_PAY_TYPE = "pay_type";

    public static final String COL_SATISFACTION = "satisfaction";

    public static final String COL_IS_BOOK = "is_book";

    public static final String COL_IS_CANCEL = "is_cancel";

    public static final String COL_IS_TIMELY_RESPONSE = "is_timely_response";
